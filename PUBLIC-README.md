...
3. Choose the apps you use in the sidebar after choosing Pebble or Even G2. Follow the numbered setup steps. Beepster needs Beeper Desktop signed in with its local API enabled; Notesy needs a selected Obsidian vault; Reminderz and Eventz/DayFrame need the corresponding macOS permissions.
...
This is the Developer ID direct-distribution release. Pome remains exclusive to the App Store edition.

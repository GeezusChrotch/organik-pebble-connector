    ...
    var body: some View {
        ScrollView {
            VStack(alignment:.leading,spacing:22) {
                ...
                Text("App preferences are in each app’s Even phone settings. Beepster also has a glasses Settings menu for reading and media options. Pome is coming to the Apple App Store edition; unavailable in this download.").font(.callout).foregroundStyle(.secondary)
                }
